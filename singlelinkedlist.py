...
#fastR becomes None when there are even number of nodes and fastR.link becomes None if there are od number of nodes
  ...
  def remove_cycle(self):
    ...
    print("Number of nodes included in the cycle are : ",len_rem_list)
...
while True:
  ...
  print("6.Insert the node after the specified node")
  print("7.Insert the node before the specified node")
  ...
  try:
    option = int(option)
    if option > 19:
      print("Option is invalid. Please enter integers between 1 to 19")
  except:
    print("Invalid type. Please enter integers between 1 to 19")
  ...
  if option == 1:
    ...
    data = int(input("Enter to be inserted : "))
    ...
    if list.has_cycle():
      ...
      print("The list doesn't have a cycle")
