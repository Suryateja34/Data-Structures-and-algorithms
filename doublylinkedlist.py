...
class DoubleLinkedList(object):
  ...
  def create_list(self):
    ...
    try:
      ...
      print("Inavlid input.Enter a integer")
    # if n == 0:
    #   return 
    # data = int(input("Enter the first element to be inserted : "))
    # self.insert_in_empty_list(data)
  ...
  def insert_after(self,data,x):
    ...
    if p is None:
      ...
      if p.next is not None:
        p.next.prev = temp #ahould not be done when p refers to last node
      p.next = temp
...
while True:
  ...
  try:
    option = int(option)
    if int(option) > 11 :
      print("Please enter the number between 1 to 11.")
  except:
    print("Invalid entry. Please enter any number between 1 to 11 : ")
  ...
  if option == 1:
    ...
    data = int(input("Enter the element to be inserted :"))
    x = int(input("Enter the element after which the node should be inserted "))
    list.insert_after(data, x)
  elif option == 6:
    data = int(input("Enter the element to be inserted :"))  
    x = int(input("Enter the element before which the node should be inserted "))
